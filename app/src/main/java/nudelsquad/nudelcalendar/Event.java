...
public class Event {
    ...
    public Event(int EVENT_ID, String EVENT_NAME, String EVENT_START,  String EVENT_END, String EVENT_DATUM, String EVENT_TYPE,  String EVENT_LOCATION, int EVENT_COLOR) {
